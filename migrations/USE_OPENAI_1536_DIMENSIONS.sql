...
-- Run this migration when using EMBEDDING_MODE=OPENAI
-- Uses OpenAI text-embedding-3-small (requires API key)
-- ================================================
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE '✓ OPENAI EMBEDDINGS CONFIGURED (1536 dimensions)';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Model: text-embedding-3-small';
    RAISE NOTICE 'Dimensions: 1536';
    RAISE NOTICE 'Cost: ~$0.02 per 1,000 messages';
    RAISE NOTICE '';
    RAISE NOTICE 'Next Steps:';
    RAISE NOTICE '1. Set EMBEDDING_MODE=OPENAI in .env';
    RAISE NOTICE '2. Set OPENAI_API_KEY=sk-... in .env';
    RAISE NOTICE '3. Restart Python backend';
    RAISE NOTICE '4. Embeddings will generate automatically';
    RAISE NOTICE '========================================';
END $$;
