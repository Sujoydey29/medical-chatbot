-- ================================================
-- Quick Fix: Force Update Vector Dimensions to 384
-- This drops and recreates columns - all existing embeddings will be lost
-- ================================================
...
-- Step 2: Add new columns with correct dimensions (384)
...
DO $$
BEGIN
    RAISE NOTICE '✓ Fixed! Columns now use vector(384) for FREE Sentence-Transformers model.';
